...
export default class FollowScreen extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = JSON.parse('{\"list\":[{\"status\":\"0\",\"surveyId\":\"fa7022f13d824d1d9334a94cf4d86d1f\",\"surveyName\":\"系统满意度调查\",\"answerAt\":null,\"surveyUrl\":\"https://survey.gomeiguo.com/index.php/696212\",\"statusName\":\"进行中\",\"surveyDate\":\"2019-09-02\"},{\"status\":\"0\",\"surveyId\":\"fa7022f13d824d1d9334a94cf4d86d1f\",\"surveyName\":\"系统满意度调查\",\"answerAt\":null,\"surveyUrl\":\"https://survey.gomeiguo.com/index.php/696212\",\"statusName\":\"进行中\",\"surveyDate\":\"2019-09-02\"}]}');
  }
  ...
  _renderItem = ({item,index}) =>(
    <TouchableOpacity activeOpacity={0.8} style={styles.itemStyle} key = {`${item.id}${index}`}>
      <View style={styles.contentStyle}>
        ...
        <Text style={styles.nornalText}>{item.surveyDate}</Text>
      </View>
    </TouchableOpacity>
    )
}
